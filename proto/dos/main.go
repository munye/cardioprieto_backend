...
type Estudio struct {
	...
	Campos     []Campo `gorm:"type:Campos" json:"campos"`
}

// NewEstudio creates a new composite.
func NewEstudio(pacienteID uint) *Estudio {
	return &Estudio{PacienteID: pacienteID, Campos: make([]Campo, 0)}
}

// Add adds a new component to the composite.
func (e *Estudio) Add(campo *Campo) {
